...
def main() -> int:
    ...
    run("market_truth_guard.py", required=False)
    run("stop_execution_guard.py", required=False)
    run("learning_quarantine.py", required=False)
    ...
    run("decision_truth_replay.py", required=False)
    run("major_move_forensics.py", required=False)
    run("profit_capture_engine.py", required=False)
    run("time_intelligence.py", required=False)
    run("experience_store.py", required=False)
    run("reward_engine.py", required=False)
    run("counterfactual_lab.py", required=False)
    run("adversarial_learning_challenger.py", required=False)
    run("curriculum_engine.py", required=False)
    run("learning_governor.py", required=False)
